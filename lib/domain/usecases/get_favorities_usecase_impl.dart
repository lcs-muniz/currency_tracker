...
class GetFavoriteCurrenciesUsecase implements IGetFavoriteCurrenciesUseCase {
  final ICurrencyRepository _repository;

  GetFavoriteCurrenciesUsecase({required ICurrencyRepository repository})
    : _repository = repository;

  @override
  Future<CurrencyListResult> call([NoParams params = const ()]) async {
    return _repository.getFavoriteCurrencies();
  }
}
